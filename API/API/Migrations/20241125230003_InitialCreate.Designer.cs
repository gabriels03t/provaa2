...
namespace API.Migrations
{
    ...
    [Migration("20241125230003_InitialCreate")]
            ...
            modelBuilder.Entity("API.Models.Categoria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CriadoEm = new DateTime(2024, 11, 26, 20, 0, 2, 891, DateTimeKind.Local).AddTicks(3541),
                            Nome = "Trabalho"
                        },
                        new
                        {
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 11, 27, 20, 0, 2, 891, DateTimeKind.Local).AddTicks(3552),
                            Nome = "Estudos"
                        },
                        new
                        {
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 11, 28, 20, 0, 2, 891, DateTimeKind.Local).AddTicks(3588),
                            Nome = "Lazer"
                        });
                });
            ...
            modelBuilder.Entity("API.Models.Tarefa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoriaId = "bfe4e7dc-81e4-4e47-a67b-d4fbf3e124bd",
                            CriadoEm = new DateTime(2024, 12, 2, 20, 0, 2, 891, DateTimeKind.Local).AddTicks(3732),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 11, 28, 20, 0, 2, 891, DateTimeKind.Local).AddTicks(3738),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 12, 9, 20, 0, 2, 891, DateTimeKind.Local).AddTicks(3743),
